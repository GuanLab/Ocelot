...
path3='./ocelot/'
# ocelot without DNA sequence in npy format
path4='./npy/'
...
list_out.append(open('score_ocelot_nodna.txt','w'))
...
for the_assay in assay_all:
    ...
    for the_cell in dict_assay_cell[the_assay]:
        ...
        for k,the_chr in enumerate(chr_all):
            ...
            # 4.ocelot without DNA
            mat[4,:]=np.load(path4 + 'pred25bp_' + the_id + '_' + the_chr + '.npy')
